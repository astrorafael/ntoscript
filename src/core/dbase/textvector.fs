...
$Revision: 522 $
$Author: astrorafael $
$HeadURL: file:///home/desa/repos/ntoscript/trunk/src/core/dbase/textvector.fs $
...
\ ==========================
\ *N *\fo{TEXT-VECTOR} class
\ ==========================

\ *P The *\fo{TEXT-VECTOR} class is the container for all the
\ ** *\fo{TEXT-ITEM} objects contained within.
...
\ +G Send *\f{<newTextVector ...>}.
     ." <newTextVector"  space this [parent] begin-xml
