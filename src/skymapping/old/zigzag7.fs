...
$Revision: 522 $
$Author: astrorafael $
$HeadURL: file:///home/desa/repos/ntoscript/trunk/src/skymapping/old/zigzag7.fs $
...
\ +G Passes to next DEC band from the initial DEC, decrementing RA
\ +* and returns updated sky point *\i{p1}.
  ...
  m:   ( this -- p1 True | False )	\ overrides (next-band-)
\ +G Passes to next DEC band from the final DEC, decrementing RA
\ +* and returns updated sky point *\i{p1}.
     false m-zigzag !
     this dup (dec/) dup (ra-)
     (ra<?) if false exitm then
