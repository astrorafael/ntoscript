...
$Revision: 522 $
$Author: astrorafael $
$HeadURL: file:///home/desa/repos/ntoscript/trunk/src/skymapping/zigzag2.fs $
...
\ +G Passes to next RA band from the final RA, decrementing DEC
\ +* and returns updated sky point *\i{p1}.
  ...
  m:   ( this -- p1 True | False )	\ overrides (next-band-)
\ +G Passes to next RA band from the initial RA, decrementing DEC
\ +* and returns updated sky point *\i{p1}.
     false m-zigzag !
     this dup (/ra) dup (dec-)
     (dec<?) if false exitm then
